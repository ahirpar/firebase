...
<button class="btn btn-space btn-default" onclick=\'return editSpecial("' + childSnapshot.key + '")\'>Edit</button> <button class="btn btn-space btn-primary hover" onclick=\'return delSpecial("' + childSnapshot.key + '")\'>Delete</button></td>  </tr>';
    });
    specialList1 += '</tbody>';
    specialList1 += '</thead>';
