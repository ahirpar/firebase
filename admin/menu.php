            ...
            <div class="modal-body">
                <div class="">
                    ...
                    <div class="col-md-12">
                        ...
                        <!--<input type="text" id="igdata" name="igdata" style="width:100%">-->
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mt3">
                                    ...
                                    <div class="btn-group btn-hspace fright">
                                        ...
                                        <!--<input type="text" name="file_hd" id="file_hd" value="0">-->
                                        ...
                                        <div class="col-sm-8">
                                            <div class="panel panel-default">
                                                <div class="tab-container">
                                                    ...
                                                    <div class="tab-content" id="inttab"></div>
                                                    <ul class="nav nav-tabs" id="IngredientsList1"></ul>
                                                    <div class="tab-content" id="inttab1"></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="clear"></div>
                                        <form id="addIngredients-form">
                                            <div class="form-group mt3"> 
                                                ...
                                                <div class="col-md-2 pp0">
                                                    ...
                                                    <select class="form-control input-xs xs-mb-20" id="editdrpdownIngredients" name="editdrpdownIngredients"></select>
                                                </div>
                                                <div class="col-md-2">
                                            ...
                                            <div class="col-sm-8">
                                                <div class="panel panel-default">
                                                    <div class="tab-container">
                                                        ...
                                                        <div class="tab-content" id="extraTab"></div>
                                                        <ul class="nav nav-tabs" id="ExtraList1"></ul>
                                                        <div class="tab-content" id="extraTab1"></div>
                                        ...
                                        <form id="addExtra-form">
                                            <div class="form-group mt3">
                                                ...
                                                <div class="col-md-2 pp0">
                                                    ...
                                                    <select class="form-control input-xs xs-mb-20" id="editdrpdownExtra" name="editdrpdownExtra"></select>
                                                </div>
                                                <div class="col-md-2">
                                                    <div class="input-group xs-mb-20"><span class="input-group-addon input-xs">$</span>
